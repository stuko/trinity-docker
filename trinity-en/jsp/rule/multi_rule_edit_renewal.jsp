...
<div id="div_rule_menu" style="width:400px;position:absolute;display:none;background-color:white;border: 2px double #CCCCCC; z-index:200;">
  <form name="frmMenu">
    <ul style="list-style:none ;padding: 10px 25px 10px 25px;">
      ...
      <li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:goDetail();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;더보기</a></li>    
...
KeywordManager.prototype.getKeywordID = function(idx){
  ...
  document.location.href = '/Anaconda.do?CMD=CMD_SEQ_100695867991664233307135&seq='+this.seq+'&min_seq='+this.min_seq+'&rule_group=<%=rule_group%>&kind=<%=kind%>';
}
      ...
      if(object.response[i].parent_seq == -1) {
        ...
        a.innerHTML =   "<br/><img src='/jsp/bestmember/img/home.png' width='20'>"   +  "&nbsp;<b>" + object.response[i].context_name + '<br>' + (object.response[i].rule != null && object.response[i].rule != 'null' ? object.response[i].rule : '') + "</b>&nbsp;&nbsp;"  ;
         ...
         if(object.response[i].rule_condition == 'true' || object.response[i].rule_condition == '0') {
           ...
           a.innerHTML = "<br/>"  + "&nbsp;<b>" + object.response[i].rule+ '</b><p>' + object.response[i].msg + "&nbsp;&nbsp;</p>"  ;
         } else{
...
<div style="z-index:10">
  ...
  <h3 ><img src="/jsp/sp/img/realtime_message.png" width="40px">&nbsp;<%=kind_ctnt%> 시나리오 관리</h3>
     <!-- Rule Tree -->
            <div>
 ...
 <li>
  <div style="margin-top:10px;">
     <input id='function_name' type="text" class="styled" size="20" style="width:200px;float: left;margin-right:10px;"> <button type="button" class="btn btn-primary" id="function_var">함수명 추가</button>
          ...
          <a style='text-decoration:none;' href='/Anaconda.do?CMD=CMD_SEQ_100695867991664233307135&rule_group=<%=rule_group%>&kind=<%=kind%>'><i class="fa fa-fw fa-sign-out"></i>&nbsp;Top</img></a>
          &nbsp;
