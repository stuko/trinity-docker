...
<div>
  <div class="content-module-heading cf" style="margin-bottom:20px;">
    <h3 class="fl">
    <i class="fas fa-question-circle"></i>&nbsp;"<%=bc.getBusinessData(0).getFieldValue("SLOT_NAME")%>" 필수 질문 > 문장 입력
    </h3>	
...
<% } %>
  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <tr><td>문장</td><td><textarea rows="3" cols="70"  name="QST_SENTENCE" id="QST_SENTENCE" class="styled" size="70"></textarea></td></tr>
      <tbody>
      <tr>
      </tr>
      </tbody>
...
function save(){
  with(frmSlotQuest){
    ...
    var d = {SLOT_KEY: $('#SLOT_KEY').val(),QST_SENTENCE: $('#QST_SENTENCE').val()};

    $.ajax({
      url: "/Anaconda.json?CMD=CMD_SEQ_101926609821582583159417",
      data: d,
      type : "POST",
      dataType: "json",
