...
<div class="container-fluid" style="z-index:10;padding-top:20px;">
     <div class="card mb-3" style="padding-bottom:40px;">
           <div class="card-header">
             <h3><img src="/jsp/sp/img/login.png" width="30px">&nbsp; Join</h3>
           </div>
          * DUNA 소프트웨어로봇 서비스를 이용해 주셔서 감사합니다. DUNA 는 소프트웨어로봇을 만들고 운영하기 위한 편리한 환경을 제공해 드립니다.
      </div>
...
<script>
 alertPopup('알림','회원가입시 입력한 이메일로 <br>인증메일이 발송됩니다.<br> 인증메일을 통해, 인증이 완료된후,<br> 로그인해 주시기 바랍니다.<br><br> 인증메일을 받지 못하실 경우, 스팸함을 확인해 주시고, 확인이 안되시는 경우 stuko@nate.com 으로 확인 의뢰해 주시면, 확인 후 처리 및 회신해 드리겠습니다.');
</script>
