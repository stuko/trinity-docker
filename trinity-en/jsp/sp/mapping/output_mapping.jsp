...
<div>
  <div class="content-module-heading cf" style="margin-bottom:20px;">
    <h3 class="fl">
<i class="fas fa-hands-helping"></i>&nbsp;Output Variables
    </h3>	
    <p>
      DUNA에서 결과로 사용할 변수들을 매핑/변환 하여 사용하고자 할 때, 쓰이는 기능입니다.
    </p>
    <code>
      <pre>
        생성할 변수 명 : MY_THOUGHT
...
function fnDelete(M_TGT_NAME){
  ...
  $.ajax({
    url : '/Anaconda.json?CMD=CMD_SEQ_102756046841630710415608' ,
    type: 'POST',
    data : d,
    dataType : 'json',
...
function fnModify(){
  ...
  $.ajax({
    url : '/Anaconda.json?CMD=CMD_SEQ_108077642831630710422767' ,
    type: 'POST',
    data : d,
    dataType : 'json',
    success : function (data){
...
function fnCreate(){
  ...
  var d = {M_TGT_NAME: $('#M_TGT_NAME').val(),M_TGT_VALUE: $('#M_TGT_VALUE').val()};     
  $.ajax({
    url : '/Anaconda.json?CMD=CMD_SEQ_108282187101630710428085' ,
    type: 'POST',
    data : d,
    dataType : 'json',
    success : function (data){
