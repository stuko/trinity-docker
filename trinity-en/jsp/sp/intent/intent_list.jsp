...
<div>
  <div class="content-module-heading cf" style="margin-bottom:20px;">
    <h3 class="fl">
<i class="fas fa-brain"></i>&nbsp;<%=bc.getBusinessData(0).getFieldValue("IG_NAME")%> : Intent
   </h3>
...
function fnSentenceList(seq,name){
   document.location.href = '/Anaconda.do?CMD=CMD_SEQ_108483648151580427270542&IG_KEY=<%=request.getParameter("IG_KEY")%>&IT_KEY=' + seq;
}
function fnSlotList(seq,name){
   document.location.href = '/Anaconda.do?CMD=CMD_SEQ_109919745451582508889092&IG_KEY=<%=request.getParameter("IG_KEY")%>&IT_KEY=' + seq;
}
function fnSlotCreate(seq,name){
   document.location.href = '/Anaconda.do?CMD=CMD_SEQ_109668521911582508938270&IG_KEY=<%=request.getParameter("IG_KEY")%>&IT_KEY=' + seq;
}
