...
BusinessCollection it = RequestHelper.getBusinessCollection(request,"getIntent");
String IT_NAME = it.getBusinessData(0).getFieldValue("IT_NAME");
%>
...
<h3 class="page-header"><i class="fas fa-highlighter"></i>&nbsp; Intent(<%=IT_NAME%>) > Sentence</h3>
...
function fnPage(seq){
	...
	document.location.href = "/Anaconda.do?CMD=CMD_SEQ_108483648151580427270542&IG_KEY=<%=bc.getBusinessData(0).getFieldValue("IG_KEY")%>&IT_KEY=<%=IT_KEY%>&pos=" + seq;
}
<% } %>
</script>
<%
