...
<input type="button" class="button white" style="font: bold 13px 돋움체;margin-left: 5px;margin-top: 5px;" value="Copy" onClick="javascript:copyRuleMove();"></input>
...
KeywordManager.prototype.copyRuleMove = function(){
	with(frmRuleMove){
		seq.value = this.seq;
		CMD.value = "CMD_SEQ_105050443491495807338244";
		code.value = "copyRuleMove";
		callAjaxByForm("copyRuleMove","frmRuleMove");				
	}
}
...
function copyRuleMove(){
	keywordManager.copyRuleMove();
}
