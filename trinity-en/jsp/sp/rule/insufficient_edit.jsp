...
<%
  BusinessCollection bc = RequestHelper.getBusinessCollection(request,"getInsufficientRuleEdit");
%>

<div class="container-fluid">

  <h2 class="pb-3 pt-2 border-bottom mb-5"><i class="far fa-calendar-alt"></i> Imperfect Rule
  <button class="btn btn-danger mr-sm-2" onClick="javascript:document.location.href='/CMD_SEQ_102922249411618043611046.do'">완성된 룰 변경하기</button>

</h2>
  <h4><i class="fas fa-chevron-right"></i><strong style="margin-left:10px;">아래 미완성 룰을 완성해 주세요</strong> <br/></h4><br/>
  <%
