...
서비스 정보 입력
  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <tr><td>서비스 이름</td><td><input type="text" name="SVC_NAME" id="SVC_NAME" size="70" class="styled"></td></tr>
      <tr><td>서비스 소개</td><td><textarea name="SVC_INTRODUCE" id="SVC_INTRODUCE" cols=40 rows=3 class="styled"></textarea></td></tr>
      <tr><td>서비스 사용여부</td><td><input type="checkbox" name="SVC_YN" id="SVC_YN" class="styled" checked>사용함</td></tr>
      <tr><td>서비스 상세내용</td><td><textarea name="SVC_DESC" id="SVC_DESC" cols=40 rows=3 class="styled"></textarea></td></tr>
      <tbody>
      <tr>
      </tr>
      </tbody>
