...
<div id="div_profile_menu" style="width:500px;position:absolute;display:none;background-color:white;border: 2px double #CCCCCC; z-index:200;">
	<form name="frmMenu">
			...
			<p style="height:30px">
				<img src="/jsp/bestmember/img/important.png" width="20px" height="20px" />&nbsp;Rule variables management&nbsp;<a style="margin-left:20px;text-decoration:none;" href='javascript:fnShowOrHide("div_profile_menu");'><img src='/jsp/anaconda/img/close.png' width='20px' height='20px' border='0' align='absmiddle' />&nbsp;close</a>
			</p>
<ul style="list-style:none ;padding: 10px 25px 10px 25px;">
			<li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:goReadProfile();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;Detail</a></li>
			<li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:goUpdateProfile();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;Modify</a></li>
			<li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:goDeleteProfile();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;Delete</a></li>
			<li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:convertProfile();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;Convert</a></li>
...
<div id="div_profile_candidate_menu" style="width:500px;position:absolute;display:none;background-color:white;border: 2px double #CCCCCC; z-index:200;">
	<form name="frmCandidateMenu">
			<p style="height:30px">
				<span><img src="/jsp/bestmember/img/important.png" width="20px" height="20px" align="absmiddle" />&nbsp;Candidated Variables<a style="margin-left:20px;text-decoration:none;" href='javascript:fnShowOrHide("div_profile_candidate_menu");'><img src='/jsp/anaconda/img/close.png' width='20px' height='20px' border='0' align='absmiddle' />&nbsp;close</a></span>
			</p>
		<ul style="list-style:none ;padding: 10px 25px 10px 25px;">
			<li><a style="text-decoration:none;" href='javascript:fnNull();' onClick='javascript:goCreateProfile();'><img src="/jsp/bestmember/img/shortcut.png" border="0" align="absmiddle"></img>&nbsp;Add</a></li>
		</ul>
	</form>
</div>
...
<div id="div_profile" style="width:900px;position:absolute;display:none;background-color:white;border: 2px double #CCCCCC;padding: 10px 10px;z-index:200;">
	...
	<form name="frmProfile" method="post" action="/Anaconda.do">
		...
		<div class="table-responsive">
				...
				<tr>
					<td>Basis or Not<br>(Priority High = Y)</td>
					<td>
				...
				<tr>
					...
					<td><textarea rows="10" cols="70" name="factor_statement" class="styled" ></textarea>
                                         <pre>
REST를 선택하신 경우, 
{
   url : "https://", 
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <h3 class="page-header">
                           <img src="/jsp/sp/img/realtime_profile.png" width="40px">&nbsp; Variables
                        </h3>
...
<h6 style="color:blue">룰 흐름  유형(duna.rule.flow.type)은 기본으로 'all' 입니다 , 값은  all , first , last 중에 한 가지를 환경 설정 파일에 정의해 주시기 바랍니다.</h6>
		...
		<h5>Current Variables&nbsp;&nbsp;<button type="button" class="btn btn-lg btn-success" onClick="javascript:fnShowProfileCandidateMenu('T');">Create Variables</button></h5>
		<!--
		<h6><button type="button" class="btn btn-warning" onClick="javascript:$('#factor_list').toggle();">Using (real time)<span id='factor_count'></button></span>
                <button type="button" class="btn btn-success" onClick="javascript:$('#factor_list_schedule').toggle();">Using (schedule)<span id='factor_schedule_count'></button></span>
		<button type="button" class="btn btn-info" onClick="javascript:$('#factor_list_candidate').toggle();">Candidated Variables<span id='factor_error_count'></button></span>
		<button type="button" class="btn btn-danger" onClick="javascript:$('#factor_list_error').toggle();">Warning Variables<span id='factor_candidate_count'></button></span>
               </h6>
                -->  
	       </div>
	      <div class="row">
					...
					if(count > 0){
						for(var i=0 ; i < count ; i++){
								...
								if(object.response[i].factor_type == 'R'){
                                                                        if(object.response[i].factor_statement
                                                                           == '') btn.setAttribute('class','btn btn-primary');
                                                                        else btn.setAttribute('class','btn btn-warning');
                                                                        cnt1++; 
