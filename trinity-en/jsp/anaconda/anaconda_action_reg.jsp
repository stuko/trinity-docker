 ...
 <%	
 	if(strCode.equals("upd")) 
	{
	    ...
	    for(int i=0;iterator.hasNext();i++)
	    {
			...
			out.println("<td width=\"30%\" bgcolor=\"#F6FCFF\">["+ajax_tag+"]<input name='ActKorName' size='50' type='text' class='styled'  value='"+action.getKOR_NAME()+"'><input name='ActName' type='hidden' value='"+action.getNAME()+"'><a href='/Anaconda.do?CMD=CMD_SEQ_109283388491287276486644&ActName="+action.getNAME()+"&ActKorName="+action.getKOR_NAME()+"&ActColName="+webActionCollection.getWEBACTION_NAME()+"&ActKorColName="+webActionCollection.getWEBACTION_KOR_NAME()+"'>GO</a></td>");
