...
try
{
	BusinessCollection bc1 = RequestHelper.getBusinessCollection(request,"pageview-now");
	BusinessCollection bc2 = RequestHelper.getBusinessCollection(request,"pageview-before");
...
<% if(i != 6){%><tr><td colspan="4"><img src="/jsp/hydra/img/analysis_pageview_line3.png" width="600px"></td></tr><%}%>
<%
