...
<div id="table-content">
	<div class="side-content">
		<div class="content-module">
			...
			<h3 class="fl">Analysis-Logging Up/Down Rate (Tagging Name : <%=request.getParameter("tag_value")%>)</h3>
		</div>
	</div>
</div>
...
try
{
	BusinessCollection bc1 = RequestHelper.getBusinessCollection(request,"now");
	BusinessCollection bc2 = RequestHelper.getBusinessCollection(request,"before");
	for(int i = 0;i < 7;i++)
	{
