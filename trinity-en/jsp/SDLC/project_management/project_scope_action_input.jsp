...
<%
	...
	String hidden = "create_process,"+ request.getParameter("ID") +","+ request.getParameter("ID");
...
<jsp:include page="/jsp/common/default-form.jsp">
	<jsp:param name="title" value="프로세스 등록" />
	<jsp:param name="action" value="/Anaconda.do?CMD=CMD_SEQ_103180836221381456398062" />
	<jsp:param name="form" value="process_enter" />
	<jsp:param name="footer" value="* 프로젝트의 Phase를 등록후, 각 Phase 별 Process를 등록해야 합니다." />
	<jsp:param name="header" value="항목,값" />
	<jsp:param name="check" value="check()" />
	<jsp:param name="check_message" value="" />
	<jsp:param name="column" value="PROCESS NAME" />
	<jsp:param name="type" value="text" />
	<jsp:param name="css" value="styled" />
	<jsp:param name="name" value="process_subject" />
	<jsp:param name="size" value="100" />
	<jsp:param name="hidden_name" value="code,PHASE_SEQ1,PHASE_SEQ2" />
...
<jsp:include page="/jsp/common/default-view.jsp">
	<jsp:param name="title" value="프로세스 목록" />
	<jsp:param name="view_col_name" value="Project" />
	<jsp:param name="view_proc_name" value="getProcessList" />
	<jsp:param name="header" value="번호,소유자 아이디,프로제스 이름,등록일시" />
        <jsp:param name="column" value="ID,OWNER_ID,PROCESS_SUBJECT,REG_DT" />
	...
	<jsp:param name="link_bit" value="1,1,1,0" />
	<jsp:param name="link" value="/Anaconda.do?CMD=CMD_SEQ_103138080441381459214109" />
</jsp:include>
