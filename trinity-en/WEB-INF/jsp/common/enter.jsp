 ...
 <h2 class="mt-5">회원가입</h2>
  <form id="form-login">
   ...
   <div class="form-group">
    ...
    <input type="password2" class="form-control" id="password" placeholder="비밀번호를 재입력해 주세요" required="required">
   </div>
   <button id="btn-enter" class="btn btn-default">회원가입</button>
   <button id="btn-go-login" class="btn btn-primary">로그인</button>
