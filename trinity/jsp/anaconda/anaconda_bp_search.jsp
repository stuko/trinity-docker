...
<!--
function fn_FrmInput(data1,data2)
{
	var object = eval(<%=strObject%>);
	object.jndiname.value = data1;
	object.service_name.value = data2;
	self.close();
	return;
}
//-->
...
<p></p>
<form name="frm" method="POST" action="/Anaconda.do?CMD=CMD_SEQ_100900150121290598597624&title=비즈니스프로세스조회">
		  ...
		  <tr>
			...
			<td>
			  <SELECT NAME='srh_param'>
			    ...
			    <OPTION value='BP' <%=strParam.equals("BP")?"selected":""%>>비즈니스 프로세스 명</OPTION>
	  		  </SELECT>
                         </td>
                         <td>
			...
			try
			{
				...
				if(it != null)
				{
					...
					{    				
						...
						Iterator subIt = businessCollection.iterator();
						for(int j = 0; subIt.hasNext(); j++)
						{
							BusinessData bd = (BusinessData)subIt.next();
						    out.println("<tr align=\"left\">");
						    out.println("<td width=\"20%\" height=\"20\"  bgcolor=\"#FFFFFF\"><b>"+businessCollection.getBIZ_COLLECTION_KOR_NAME()+ "</b></td>");
						    out.println("<td width=\"30%\" height=\"20\"  bgcolor=\"#FFFFFF\">"+businessCollection.getBusinessName()+"</td>");
						    out.println("<td width=\"30%\" height=\"20\"  bgcolor=\"#FFFFFF\">"+bd.getBusinessName()+"</td>");
						    out.println("<td width=\"20%\" align=\"center\" bgcolor=\"#FFFFFF\">&nbsp;&nbsp;<button class=\"button white\" type=\"button\" name=\"btn_"+i+ "\" value=\"확인\" onClick=\"javascript:fn_FrmInput('"+businessCollection.getBusinessName()+"','"+bd.getBusinessName()+"');\">확인</button></td>");
						    out.println("</tr>");
						}
					}	
				}
