...
<body>
    ...
    <a class="navbar-brand font-weight-bolder mr-3" href="index.html"><img src="/jsp/chatvatar/img/chatvatar.jpeg" width="60px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		<li class="nav-item" style='font-family:카페24 동동'>
                   언제 무엇을 해야 할지 모를때, 챗바타에서 찾아 보세요
                </li>
<!--
                <% if(!"0".equals(LEVEL)) { %>
                <li class="nav-item">
