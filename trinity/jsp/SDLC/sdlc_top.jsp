...
<div id="header">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<font size="3" style="font-family:돋움"></font>&nbsp;&nbsp;<input type="text" value="Search" name="search" size="50" class="styled" style="font-weight:bold;height:35px;font-size:23px;line-height:30px;border-color:blue;color:#9900FF;font-family:Arial;" onfocus="javascript:fnSelectSearch();"/>
	&nbsp;&nbsp;&nbsp;&nbsp;
