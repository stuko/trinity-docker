...
<%
	...
	String hidden = "create,"+ request.getParameter("SEQ") +","+ request.getParameter("SEQ");
...
<jsp:include page="/jsp/common/default-form.jsp">
	...
	<jsp:param name="column" value="PHASE NAME" />
	<jsp:param name="type" value="text" />
	<jsp:param name="css" value="styled" />
	<jsp:param name="name" value="phase_subject" />
	<jsp:param name="size" value="100" />
	<jsp:param name="hidden_name" value="code,PROJECT_SEQ1,PROJECT_SEQ2" />
...
<jsp:include page="/jsp/common/default-view.jsp">
	<jsp:param name="title" value="단계 목록" />
	<jsp:param name="view_col_name" value="Project" />
	<jsp:param name="view_proc_name" value="getPhaseList" />
	<jsp:param name="header" value="아이디,소유자 아이디,단계 이름,등록일시" />
        <jsp:param name="column" value="ID,OWNER_ID,PHASE_SUBJECT,REG_DT" />
	<jsp:param name="view_parameter_name" value="SEQ" />
	<jsp:param name="view_parameter_value" value='<%=request.getParameter("SEQ")%>' />
