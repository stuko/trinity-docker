...
<!-- alert 팝업 -->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="js-scroll-trigger" href="javascript:duna();">DUNA 챗봇 서비스<sup style="font-size:15px;color:white;">free</sup></a>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in" >놀라운 챗봇 개발/운영 서비스를 경험해 보세요</div>
        ...
        <a class="btn btn-info btn-xl text-uppercase js-scroll-trigger" href="javascript:fnGuide()">챗봇 'DUNA' 사용법</a> 
        &nbsp;<a class="btn btn-secondary btn-xl text-uppercase js-scroll-trigger" href="http://lecture.bestmember.net/" target="_new">챗봇 'DUNA' 동영상</a> 
        &nbsp;<a class="btn btn-warning btn-xl text-uppercase js-scroll-trigger" href="https://telegram.me/socialproject_bot?game=socialproject" target="_new">챗봇 'DUNA' Telegram</a> 
        <div style="margin-top:40px;margin-bottom:100px;"><br></div>
<!--        <div style="margin-top:40px;margin-bottom:100px;"><a href="https://telegram.me/socialproject_bot?game=socialproject" target="_new"><i class="fab fa-telegram-plane" style="margin-right:5px;"></i>텔레그램 프로젝트 관리 챗봇 체험하기</a></div> -->
      </div>
    </div>
  </header>
  ...
  <footer class="footer">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-12">
          <span class="copyright">Copyright &copy; https://app.bestmember.net 2019</span>
