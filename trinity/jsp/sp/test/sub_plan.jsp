...
<div class="container-fluid">
  ...
  <h2 class="pb-3 pt-2 border-bottom mb-5"><i class="far fa-map"></i><span class="ml-md-3 text-secondary"><%=planTitle%></span>'s 하위 계획 세우기  <button class="btn btn-primary" onClick="javascript:document.location.href='/CMD_SEQ_103947739801607988778909.do'">돌아가기</button>
  </h2>
