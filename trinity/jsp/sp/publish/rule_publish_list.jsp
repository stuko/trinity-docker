...
%>
 ...
 <div class="container-fluid">
	<h3 class="page-header"><img src="/jsp/sp/img/context.png" width="40px">&nbsp; 대화 시나리오 공개하기 <i class="fas fa-certificate fa-2x" style="color:#FF5733;"></i></h3>
        <p>
 ...
 <div class="card-block">
   <div class="table-responsive">
	...
	<tr>
		...
		<td><img src="/download/<%=bc2.getBusinessData(i).getFieldValue("PS_IMAGE")%>" width="50"></td>
