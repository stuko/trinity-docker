...
<h3 class="page-header"><img src="/jsp/sp/img/function.png" width="40px">&nbsp;컨테이너 스크립트 관리</h3>
<df>
 컨테이너 스크립트란?
</df>
<dl>
...
<!--
<select class="container_name" id="container_name">
    <%
    String lists =  (String)request.getAttribute("getContainerList");
    out.println(lists);
    if(lists != null && lists.trim().length() > 0) {
      com.stuko.anaconda.util.MapUtil util = new com.stuko.anaconda.util.MapUtil();
      java.util.Map<String,Object> map = util.json2Map(lists);
      java.util.List<String> list = (java.util.List<String>)map.get("result");
    }
    %>
     <option value="">현재수정중입니다......</option>
