...
<h3 class="page-header"><img src="/jsp/sp/img/function.png" width="40px">&nbsp; 룰 함수 관리 </h3>
...
for(int i = 0; i < bc.size(); i++){
	...
	<tr>
		...
		<td>
           ...
           <br><br>
           <input type="button" class="btn btn-secondary" value="publish" onClick="javascript:purgeFunction('<%=bc.getBusinessData(i).getFieldValue("function_name")%>');"></input>
           </div>
                </td>
	</tr>
   <%
