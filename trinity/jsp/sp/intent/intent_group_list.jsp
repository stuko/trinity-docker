...
<div>
  <div class="content-module-heading cf" style="margin-bottom:20px;">
    <h3 class="fl">
<i class="fas fa-cubes"></i>&nbsp;대화 의도 그룹 정보 목록
    </h3>	
  <span class="fr">
   <input type="button" class="btn btn-secondary" name="Register" value="대화 의도 그룹 등록하기" onClick="javascript:goRegister();">
  </span>
  <span class="fr">
   <input type="text" class="styled" style="margin-left:300px;" name="search" size="30" value="">
  </span>
  <span class="fr">
   <input type="button" class="btn btn-info" id="Search" name="Search" value="의도 검색하기" onClick="javascript:goSearch();">
  </span>
