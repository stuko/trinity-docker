...
%>
      <tr>
        <td><%=bc.getBusinessData(i).getFieldValue("PMCode")%></td>
        <td><%=bc.getBusinessData(i).getFieldValue("PMStartDateTime")%></td>
        <td><%=bc.getBusinessData(i).getFieldValue("PMEndDateTime")%></td>
        <td>
