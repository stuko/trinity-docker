...
상품 포트폴리오 정보 입력
  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <tr><td>상품 포트폴리오 이름</td><td><input type="text" name="PORT_NAME" id="PORT_NAME" size="70" class="styled"></td></tr>
      <tr><td>포트폴리오 가격</td><td><input type="text" name="PORT_FIXED_PRICE" id="PORT_FIXED_PRICE" size="10" class="styled">원</td></tr>
      <tr><td>상품 포트폴리오 할인율</td><td><input type="text" name="PORT_FIXED_DC_RATE" id="PORT_FIXED_DC_RATE" size="10" class="styled">%</td></tr>
      <tr><td>상품 포트폴리오 소개</td><td><textarea name="PORT_INTRODUCE" id="PORT_INTRODUCE" cols=40 rows=3 class="styled"></textarea></td></tr>
      <tr><td>상품 포트폴리오 전시여부</td><td><input type="checkbox" name="PORT_DISPLAY_YN" id="PORT_DISPLAY_YN" class="styled" checked>전시함</td></tr>
      <tr><td>상품 포트폴리오 전시내용</td><td><textarea name="PORT_DISPLAY" id="PORT_DISPLAY" cols=40 rows=3 class="styled"></textarea></td></tr>
      <tbody>
      <tr>
      </tr>
      </tbody>
