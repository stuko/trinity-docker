...
BusinessData bd = request.getAttribute(InitClass.getBusinessDataValue());
String memberJndi = bd.getFieldValue("memberJndi");
IAuth auth = (IAuth)request.getAttribute(InitClass.getSessionValue());
auth.setAuthItem("jndi",memberJndi);
