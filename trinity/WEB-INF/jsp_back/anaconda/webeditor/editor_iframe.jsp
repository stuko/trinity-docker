...
%>
  ...
  <form id="get-data-form" method="post"  name="getDataForm">
		...
		<input type="text" name="file" class="file" id="file" size="50" value="<%=file%>"> &nbsp; 
		<input type="button" value="Read file" onClick="javascript:readFile();" class="styled">&nbsp;
		<input type="button" value="Save file" onClick="javascript:saveFile();" class="styled">
		</div>
		<br>
		<div>
		    <iframe>
