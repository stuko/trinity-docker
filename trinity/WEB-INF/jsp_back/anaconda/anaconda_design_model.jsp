...
<div class="post">
	...
	<h2><font><b>Design Model</b> - Table</font></h2>
	</div>
</div>
...
<table class="table_hydra" cellspacing="0" cellpadding="0">
 <caption>Entity</caption>
		...
		<thead>
		<tr>
		<th scope="col">Entity List&nbsp;<input type="button" class="button white" value="전체삭제" onClick="javascript:fnDeleteAll();"></input></th>
		</tr>
		</thead>
		<tbody>
		<tr><td align="center">
...
DefaultXmlDataCollection col = res.getDefaultXmlDataCollection(com.stuko.anaconda.value.BlankField.DESIGN_MODEL);
if(col != null)
{
	...
	for(;it.hasNext();)
	{
		...
		%>
		<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<img src="/jsp/anaconda/img/table.png"  width='30px' height='30px' border='0' align="absmiddle">&nbsp;
		<a  href="javascript:fnNull();" onClick="javascript:fnShowOrHideMenu('menu_<%=i %>');"><%=BusinessHelper.getSubString(dxd.getData(strKey),10,"...") %></a>
		...
		<img src='/jsp/anaconda/img/close.png' width='20px' height='20px' border='0' align='absmiddle' />&nbsp;&nbsp;<a href='javascript:fnShowOrHide("menu_<%=i %>");' style="font-size:12px;"><b>close</b></a>
			<br/>
				<ul>
				<li><a href="javascript:fnNull();" onClick="javascript:fnRemoveDesignKeyword('<%=dxd.getNAME()%>','<%=strKey%>')">Entity 삭제</a></li>
				<li>DesignModel <input type="button" value="속성추가" onClick="javascript:addAttribute();"> </li>
